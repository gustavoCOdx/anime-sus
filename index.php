        ...
        <section id="pagina-home">
            <header>
                ...
                <nav class="menu-principal">
                    <ul>
                        <li><a href="mailto:gustavohelena95@gmail.com" class="link-ativo">contato</a></li>
                    </ul>
                </nav>
            </header>
            <main>
                    ...
                    <div class="col-12 col-sm-2 col-md-6 col-lg-6 mt-2">
                        <div class="card" style="height: 100%">
                            ...
                            <form action="anime-salvar.php" method="POST" enctype="multipart/form-data">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Titúlo do Anime</label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="qtd" class="form-control" id="exampleInputEmail1"
                                                aria-describedby="Qtd de Episódios">
                                        </div>
